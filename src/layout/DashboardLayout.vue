  ...
  >
                      ...
                      >
                        ...
                        <div class="menu-submenu">
                          ...
                          <ul class="menu-subnav">
                            ...
                            <li class="menu-item" aria-haspopup="true">
                              <a
                                href="custom/pages/login/login-3.html"
                                class="menu-link"
                              >
                                <i class="menu-bullet menu-bullet-dot">
                                  <span></span>
                            ...
                            <li class="menu-item" aria-haspopup="true">
                              <a
                                href="custom/pages/login/login-4.html"
                                class="menu-link"
                              >
                                <i class="menu-bullet menu-bullet-dot">
                                  <span></span>
                            ...
                            >
                              ...
                              <div class="menu-submenu">
                                ...
                                <ul class="menu-subnav">
                                  <li class="menu-item" aria-haspopup="true">
                                    <a
                                      href="custom/pages/login/login-5/signup.html"
                                      class="menu-link"
                                    >
                                      <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                  ...
                                  <li class="menu-item" aria-haspopup="true">
                                    <a
                                      href="custom/pages/login/login-5/signin.html"
                                      class="menu-link"
                                    >
                                      <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                  ...
                                  <li class="menu-item" aria-haspopup="true">
                                    <a
                                      href="custom/pages/login/login-5/forgot.html"
                                      class="menu-link"
                                    >
                                      <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
              ...
              >
                ...
                <div class="d-flex align-items-center">
                  ...
                  <a
                    href="#"
                    class="
                      btn btn-clean btn-hover-light-primary-
                      active
                      btn-sm
                      font-weight-bold font-size-base
                      mr-1
                  ...
                  <a
                    href="#"
                    class="
                      btn btn-clean btn-hover-light-primary- btn-sm
                      font-weight-bold font-size-base
                      mr-1
                    "
                    >Month</a
              ...
              <div class="container">
                ...
                <div class="row">
                  <div class="col-lg-6 col-xxl-4">
                    ...
                    <div
                      class="card card-custom bg-gray-100 card-stretch gutter-b"
                    >
                      <!--begin::Header-->
                        ...
                        <div class="card-spacer mt-n25">
                          ...
                          <div class="row m-0">
                            ...
                            >
                              <span
                                class="
                                  svg-icon svg-icon-3x svg-icon-primary
                                  d-block
                                  my-2
                                "
                              >
                          ...
                          <div class="row m-0">
                            ...
                            >
                              <span
                                class="
                                  svg-icon svg-icon-3x svg-icon-danger
                                  d-block
                                  my-2
                                "
                              >
                        ...
                        <div class="timeline timeline-5 mt-3">
                          ...
                          <div class="timeline-item align-items-start">
                            ...
                            <div class="timeline-content text-dark-50">
                              Outlines of the recent activities that happened
                              last weekend
                            </div>
                            <!--end::Text-->
                          </div>
                          ...
                          <div class="timeline-item align-items-start">
                            ...
                            <div class="timeline-badge">
                              <i
                                class="fa fa-genderless text-danger icon-xxl"
                              ></i>
                            </div>
                            <!--end::Badge-->
                            <!--begin::Content-->
                            <div class="timeline-content d-flex">
                              <span class="mr-4 font-weight-bolder text-dark-75"
                                >AEOL meeting with</span
                              >
                              <!--begin::Section-->
                          ...
                          <div class="timeline-item align-items-start">
                            ...
                            <div class="timeline-badge">
                              <i
                                class="fa fa-genderless text-info icon-xxl"
                              ></i>
                            </div>
                            <!--end::Badge-->
                            <!--begin::Desc-->
                          ...
                          <div class="timeline-item align-items-start">
                            ...
                            <!--begin::Text-->
                            <div class="timeline-content text-dark-50">
                              Project scoping &amp; estimations with
                              stakeholders.
                            </div>
                            <!--end::Text-->
                          </div>
                          ...
                          <div class="timeline-item align-items-start">
                            ...
                            <div class="timeline-badge">
                              <i
                                class="fa fa-genderless text-warning icon-xxl"
                              ></i>
                            </div>
                            <!--end::Badge-->
                            <!--begin::Desc-->
                        ...
                        <div class="d-flex align-items-center mb-10">
                          ...
                          >
                            <a
                              href="#"
                              class="
                                btn btn-hover-light-primary btn-sm btn-icon
                              "
                              data-toggle="dropdown"
                              aria-haspopup="true"
                              aria-expanded="false"
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                          ...
                          <div class="dropdown dropdown-inline">
                            <a
                              ...
                              class="
                                ...
                                font-size-sm font-weight-bolder
                                dropdown-toggle
                                text-dark-75
                              "
                              data-toggle="dropdown"
                      ...
                      <div class="card-body pt-2">
                        ...
                        <div class="d-flex align-items-center mb-10">
                          ...
                          <div class="d-flex flex-column flex-grow-1">
                            <a
                              ...
                              class="
                                text-dark-75 text-hover-primary
                                font-size-sm font-weight-bold font-size-lg
                                mb-1
                              "
                              >Scoping &amp; Estimations</a
                            >
                            <span class="text-muted font-weight-bold"
                              >Due in 5 Days</span
                            >
                        ...
                        <div class="d-flex align-items-center mb-10">
                          <!--begin::Bullet-->
                          <span
                            class="bullet bullet-bar bg-info align-self-stretch"
                          ></span>
                          <!--end::Bullet-->
                          <!--begin::Checkbox-->
                          <label
                      ...
                      <div class="card-body pt-0">
                        ...
                        <div class="mb-10">
                          ...
                          <p class="text-dark-50 m-0 pt-5 font-weight-normal">
                            A brief write up about the top Authors that fits
                            within this section
                          </p>
                          <!--end::Desc-->
                        </div>
                        ...
                        <div class="mb-10">
                          ...
                          <!--begin::Desc-->
                          <p class="text-dark-50 m-0 pt-5 font-weight-normal">
                            A brief write up about the Popular Authors that fits
                            within this section
                          </p>
                          <!--end::Desc-->
                        </div>
                        ...
                        <div class="">
                          ...
                          <!--begin::Desc-->
                          <p class="text-dark-50 m-0 pt-5 font-weight-normal">
                            A brief write up about the New Users that fits
                            within this section
                          </p>
                          <!--end::Desc-->
                        </div>
                      ...
                      <div class="card-body d-flex flex-column">
                        ...
                        <div class="pt-5">
                          <p
                            ...
                            "
                          >
                            Notes: Current sprint requires stakeholders <br />to
    ...
    <ul class="sticky-toolbar nav flex-column pl-2 pr-2 pt-3 pb-3 mt-4">
      ...
      >
        <a
          class="
            btn btn-sm btn-icon btn-bg-light btn-text-success btn-hover-success
          "
          href="#"
        >
          <i class="flaticon2-drop"></i>
      ...
      >
        <a
          class="
            btn btn-sm btn-icon btn-bg-light btn-text-danger btn-hover-danger
          "
          href="#"
          data-toggle="modal"
          data-target="#kt_chat_modal"
      ...
      <div class="offcanvas-content">
        ...
        <div class="offcanvas-footer">
          <a
            ...
            target="_blank"
            class="
              btn btn-block btn-danger btn-shadow
              font-weight-bolder
              text-uppercase
            "
            >Buy Metronic Now!</a
...
<style>
@import "../assets/css/dashboard/rtl/plugins.bundle.rtl.css";
@import "../assets/css/dashboard/rtl/style.bundle.rtl.css";
@import "../assets/css/dashboard/rtl/prismjs.bundle.rtl.css";
@import "../assets/css/dashboard/rtl/light.rtl.css";
